...
Heat.user.BasicForm = Ext.extend(Ext.form.FormPanel, {
    constructor: function(cfg) {
        ...
        Heat.user.BasicForm.superclass.constructor.call(this, {
            url: '/data/fare/user/update.json',
            width: 600,
            labelAlign: 'right',
            labelWidth: 80,
            frame: true,
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        store: new Ext.data.Store({
                            autoLoad: true,
                            proxy: new Ext.data.HttpProxy({url: "/data/fare/user/queryShequ.json"}),
                        ...
                        store: new Ext.data.Store({
                            autoLoad: true,
                            proxy: new Ext.data.HttpProxy({url: "/data/fare/user/queryLoudong.json"}),
                            reader: new Ext.data.ArrayReader({}, [
                                {name: 'value'},
                                {name: 'text'}
                            ])
                        ...
                        store: new Ext.data.Store({
                            autoLoad: true,
                            proxy: new Ext.data.HttpProxy({url: "/data/fare/user/queryDanyuan.json"}),
                            reader: new Ext.data.ArrayReader({}, [
                                {name: 'value'},
                                {name: 'text'}
                            ])
                        ...
                        store: new Ext.data.Store({
                            autoLoad: true,
                            proxy: new Ext.data.HttpProxy({url: "/data/fare/user/queryUnit.json"}),
                            reader: new Ext.data.ArrayReader({}, [
                                {name: 'value'},
                                {name: 'text'}
                            ])
...
Heat.user.BasicGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    constructor: function(cfg) {
        ...
        var store = new Ext.data.Store({
            proxy: new Ext.data.HttpProxy({url: "/data/fare/user/list.json"}),
