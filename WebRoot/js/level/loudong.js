...
Heat.loudong.BasicForm = Ext.extend(Ext.form.FormPanel, {
    constructor: function(cfg) {
        ...
        Heat.loudong.BasicForm.superclass.constructor.call(this, {
            url: "/heatManager/data/level/loudong/update.json",
            width: 500,
            labelAlign: 'right',
            labelWidth: 80,
            frame: true,
            ...
            items: [{
                ...
                store: new Ext.data.Store({
                    autoLoad: true,
                    proxy: new Ext.data.HttpProxy({url: "/heatManager/data/level/loudong/queryShequ.json"}),
                ...
                store: new Ext.data.Store({
                    autoLoad: true,
                    proxy: new Ext.data.HttpProxy({url: "/heatManager/data/level/loudong/queryHeat.json"}),
                    reader: new Ext.data.ArrayReader({}, [
                        {name: 'value'},
                        {name: 'text'}
                    ])
...
Heat.loudong.BasicGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    constructor: function(cfg) {
        ...
        var store = new Ext.data.Store({
            proxy: new Ext.data.HttpProxy({url: "/heatManager/data/level/loudong/list.json"}),
        ...
        Heat.loudong.BasicGrid.superclass.constructor.call(this, {
            ...
            tbar: [{
                ...
                store: new Ext.data.Store({
                    autoLoad: true,
                    proxy: new Ext.data.HttpProxy({url: "/heatManager/data/level/loudong/queryShequ.json?query=true"}),
                    reader: new Ext.data.ArrayReader({}, [
                        {name: 'value'},
                        {name: 'text'}
                    ])
    ...
    deleteRecord: function(btn) {
        ...
        if(btn == 'yes') {
            Ext.Ajax.request({
                url: '/heatManager/level/loudong/del',
                params: {bldid: id},
