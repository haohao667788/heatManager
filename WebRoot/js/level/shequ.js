...
Heat.shequ.BasicForm = Ext.extend(Ext.form.FormPanel, {
    constructor: function(cfg) {
        ...
        Heat.shequ.BasicForm.superclass.constructor.call(this, {
            url: '/heatManager/data/level/shequ/update.json',
            width: 500,
            labelAlign: 'right',
            labelWidth: 80,
            frame: true,
            ...
            items: [{
                ...
                store: new Ext.data.Store({
                    autoLoad: true,
                    proxy: new Ext.data.HttpProxy({url: "/heatManager/data/level/shequ/queryProject.json"}),
...
Heat.shequ.BasicGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    constructor: function(cfg) {
        ...
        var store = new Ext.data.Store({
            proxy: new Ext.data.HttpProxy({url: "/heatManager/data/level/shequ/list.json"}),
    ...
    deleteRecord: function(btn) {
        ...
        if(btn == 'yes') {
            Ext.Ajax.request({
                url: '/heatManager/level/shequ/del',
                params: {cmtid: id},
