...
Heat.loudong.BasicForm = Ext.extend(Ext.form.FormPanel, {
    constructor: function(cfg) {
        ...
        Heat.loudong.BasicForm.superclass.constructor.call(this, {
            url: "/static/data/level/loudong/update"+debug,
            width: 500,
            labelAlign: 'right',
            labelWidth: 80,
            frame: true,
            ...
            items: [{
                ...
                store: new Ext.data.Store({
                    autoLoad: true,
                    proxy: new Ext.data.HttpProxy({url: "/static/data/level/loudong/queryShequ"+debug}),
                ...
                store: new Ext.data.Store({
                    autoLoad: true,
                    proxy: new Ext.data.HttpProxy({url: "/static/data/level/loudong/queryHeat"+debug}),
                    reader: new Ext.data.ArrayReader({}, [
                        {name: 'value'},
                        {name: 'text'}
                    ])
...
Heat.loudong.BasicGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    constructor: function(cfg) {
        ...
        var store = new Ext.data.Store({
            proxy: new Ext.data.HttpProxy({url: "/static/data/level/loudong/list"+debug}),
        ...
        Heat.loudong.BasicGrid.superclass.constructor.call(this, {
            ...
            tbar: [{
                ...
                store: new Ext.data.Store({
                    autoLoad: true,
                    proxy: new Ext.data.HttpProxy({url: "/static/data/level/loudong/queryShequ"+debug+"?query=true"}),
                    reader: new Ext.data.ArrayReader({}, [
                        {name: 'value'},
                        {name: 'text'}
                    ])
