...
Heat.shequ.BasicForm = Ext.extend(Ext.form.FormPanel, {
    constructor: function(cfg) {
        ...
        Heat.shequ.BasicForm.superclass.constructor.call(this, {
            url: '/static/data/level/shequ/update'+debug,
            width: 500,
            labelAlign: 'right',
            labelWidth: 80,
            frame: true,
            ...
            items: [{
                ...
                store: new Ext.data.Store({
                    autoLoad: true,
                    proxy: new Ext.data.HttpProxy({url: "/static/data/level/shequ/queryProject"+debug}),
...
Heat.shequ.BasicGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    constructor: function(cfg) {
        ...
        var store = new Ext.data.Store({
            proxy: new Ext.data.HttpProxy({url: "/static/data/level/shequ/list"+debug}),
